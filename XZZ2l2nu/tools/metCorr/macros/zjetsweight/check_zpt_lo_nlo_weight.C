...
TFile* file1 = TFile::Open("/data2/XZZ2/80X_20160818_light_Skim/DYJetsToLL_M50_NoRecoil.root");
TFile* file2 = TFile::Open("/data2/XZZ2/80X_20160818_light_Skim/DYJetsToLL_M50_MGMLM_Ext1_NoRecoil.root");
