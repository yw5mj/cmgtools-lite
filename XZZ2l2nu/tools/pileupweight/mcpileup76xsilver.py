...
lg = TLegend(0.45,0.66,0.9,0.85)
lg.AddEntry(pileup_dt, "Data 50ns + 25ns Silver", "pl")
...
lg.Draw("same")
pt.Draw()
c1.SaveAs("pileup76x50ns25nsSilver.eps")
c1.SaveAs("pileup76x50ns25nsSilver.pdf")
...
puweight.SetMaximum(puweight.GetBinContent(puweight.GetMaximumBin())*1.2)
lg1 = TLegend(0.5,0.7,0.9,0.85)
lg1.AddEntry(puweight, "Data/MC 2015", "pl")
lg1.AddEntry(puweight, "50ns + 25ns Silver", "")
...
lg1.Draw()
pt.Draw()
c2.SaveAs("puweight76x50ns25nsSilver.eps")
