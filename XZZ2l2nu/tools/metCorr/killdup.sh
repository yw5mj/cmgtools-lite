...
g++ src/killdup.cc -o killdup.exe `root-config --cflags` `root-config --libs`

#inputs
infile=/data2/XZZ2/80X_20160721_EffSkim_v2/SingleEMU_Run2016BCD_PromptReco.root
outfile=/data2/XZZ2/80X_20160721_EffSkim_v2/SingleEMU_Run2016BCD_PromptReco_killdup.root
