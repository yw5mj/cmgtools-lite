{
  ...
  TFile* fin = new TFile("ForRhoWeight_DataB2H33fbinv_tight_puWeight68075_metfilter_unblind_all_1pb.root");
  TFile* fout = new TFile("rhoratio_b2h33fbinv.root", "recreate");

  gROOT->ProcessLine(".x tdrstyle.h");

  TH1D* hdt = (TH1D*)fin->Get("ForRhoWeight_DataB2H33fbinv_tight_puWeight68075_metfilter_unblind_all_1pb_rho_data_SingleEMU_Run2016B2H_ReReco_33fbinv");
  TH1D* hmc = (TH1D*)((THStack*)fin->Get("ForRhoWeight_DataB2H33fbinv_tight_puWeight68075_metfilter_unblind_all_1pb_rho_stack"))->GetHistogram();
  ...
  hratio_dt_mc->SetTitle("Rho reweighting: Normalized data/MC, 2016 data 33.59 fb^{-1}.");
  ...
  plots->Print("rho_rewegiht_b2h33fbinv.pdf");
  plots->SaveAs("rho_rewegiht_b2g33fbinv.C");
