  ...
  for(unsigned i=0;i<fNames.size();i++)
    {
      if (fNames[i] == "JetEta")
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " jet eta is not set" << std::endl;
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " jet pt is not set" << std::endl;
	    result.push_back(-999.0);
	  } else {
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " jet phi is not set" << std::endl; 
	    result.push_back(-999.0);
	  } else {
	    result.push_back(mJetPt);
	  }
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::"<<" jet energy is not set" << std::endl;
	    result.push_back(-999.0);
	  } else {
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " jet emf is not set" << std::endl;
	    result.push_back(-999.0);
	  } else {
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " lepton px is not set" << std::endl;
	    result.push_back(-999.0);
	  } else {
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " lepton py is not set" << std::endl;
	    result.push_back(-999.0);
	  } else {
	    ...
	    std::cerr << "[ERROR] JetCorrectionUncertainty::" << " lepton pz is not set" << std::endl;
	    result.push_back(-999.0);
	  } else {
	...
	std::cerr << "[ERROR] JetCorrectionUncertainty::"<<" unknown parameter "<<fNames[i] << std::endl;
	result.push_back(-999.0);
      }
    }     
  return result;      
...
float JetCorrectionUncertainty::getPtRel()
{
  ...
  if (lj2 > 0) {
    ...
    std::cerr << "[ERROR] JetCorrectionUncertainty"<<" not positive lepton-jet momentum: "<<lj2 << std::endl;
