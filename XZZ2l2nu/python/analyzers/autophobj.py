...
#    NTupleVariable("t1xyPt",  lambda x : x.corPt(ROOT.pat.MET.Type1) ),
#    NTupleVariable("t1xyPhi",  lambda x : x.corPhi(ROOT.pat.MET.Type1) ),
#    NTupleVariable("t1xySumEt",  lambda x : x.corSumEt(ROOT.pat.MET.Type1) ),
    ...
    NTupleVariable("t1Pt_JECUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_JECDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JECUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JECDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetEnDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_JERUp",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Pt_JERDn",  lambda x : x.shiftedPt(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JERUp",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResUp,ROOT.pat.MET.Type1) ),
    NTupleVariable("t1Phi_JERDn",  lambda x : x.shiftedPhi(ROOT.pat.MET.JetResDown,ROOT.pat.MET.Type1) ),
