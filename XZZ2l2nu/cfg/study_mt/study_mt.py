...
for idx,sample in enumerate(sigSamples):
    ...
    h1.append(sigPlotters[idx].drawTH1('llnunu_mt',cuts,str(lumi*1000),nbins,xmin,xmax,titlex = "M_{T}",units = "GeV"))
    h1[idx].SetName(sample+'_hmt')
    h2.append(sigPlotters[idx].drawTH1('llnunu_mta',cuts,str(lumi*1000),nbins,xmin,xmax,titlex = "M_{T}",units = "GeV"))
    h2[idx].SetName(sample+'_hmta')
    h3.append(sigPlotters[idx].drawTH1('llnunu_mtb',cuts,str(lumi*1000),nbins,xmin,xmax,titlex = "M_{T}",units = "GeV"))
    h3[idx].SetName(sample+'_hmtb')
    h4.append(sigPlotters[idx].drawTH1('llnunu_mtc',cuts,str(lumi*1000),nbins,xmin,xmax,titlex = "M_{T}",units = "GeV"))
    h4[idx].SetName(sample+'_hmtc')
