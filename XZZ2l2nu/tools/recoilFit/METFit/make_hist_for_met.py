...
# both
#h1 = Data.drawTH2('h_data_upara_zpt', 'llnunu_l1_pt:(llnunu_l1_pt+met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#parallel}(Z,MET)/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h2 = ZJets.drawTH2('h_zjets_upara_zpt', 'llnunu_l1_pt:(llnunu_l1_pt+met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#parallel}(Z,MET)/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h3 = Data.drawTH2('h_data_uperp_zpt_el', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#perp}(Z,MET)/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h4 = ZJets.drawTH2('h_zjets_uperp_zpt_el', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#perp}(Z,MET)/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")


h1 = Data.drawTH2('h_data_upara_zpt', 'llnunu_l1_pt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt', 'llnunu_l1_pt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_zeta', 'abs(llnunu_l1_eta):(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_zeta', 'abs(llnunu_l1_eta):(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_zeta', 'abs(llnunu_l1_eta):(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_zeta', 'abs(llnunu_l1_eta):(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_nvtx', 'nVert:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "nVertex", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_nvtx', 'nVert:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_nvtx', 'nVert:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_nvtx', 'nVert:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_set', 'llnunu_l2_sumEt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_set', 'llnunu_l2_sumEt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_set', 'llnunu_l2_sumEt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, "(1)", 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_set', 'llnunu_l2_sumEt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts, str(lumi*1000), 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
...
# electron
#h1 = Data.drawTH2('h_data_upara_zpt_el', 'llnunu_l1_pt:(llnunu_l1_pt+met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#parallel}(Z,MET)/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h2 = ZJets.drawTH2('h_zjets_upara_zpt_el', 'llnunu_l1_pt:(llnunu_l1_pt+met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#parallel}(Z,MET)/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")


#h3 = Data.drawTH2('h_data_uperp_zpt_el', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#perp}(Z,MET)/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h4 = ZJets.drawTH2('h_zjets_uperp_zpt_el', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#perp}(Z,MET)/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")

h1 = Data.drawTH2('h_data_upara_zpt_el', 'llnunu_l1_pt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_el', 'llnunu_l1_pt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_el', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_el', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_zeta_el', 'abs(llnunu_l1_eta):(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_zeta_el', 'abs(llnunu_l1_eta):(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_zeta_el', 'abs(llnunu_l1_eta):(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_zeta_el', 'abs(llnunu_l1_eta):(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_nvtx_el', 'nVert:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "nVertex", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_nvtx_el', 'nVert:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_nvtx_el', 'nVert:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_nvtx_el', 'nVert:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_set_el', 'llnunu_l2_sumEt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_set_el', 'llnunu_l2_sumEt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_set_el', 'llnunu_l2_sumEt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, "(1)", 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_set_el', 'llnunu_l2_sumEt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+elChannel, str(lumi*1000), 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
...
# muon
#h1 = Data.drawTH2('h_data_upara_zpt_mu', 'llnunu_l1_pt:(llnunu_l1_pt+met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#parallel}(Z,MET)/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h2 = ZJets.drawTH2('h_zjets_upara_zpt_mu', 'llnunu_l1_pt:(llnunu_l1_pt+met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#parallel}(Z,MET)/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")


#h3 = Data.drawTH2('h_data_uperp_zpt_mu', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#perp}(Z,MET)/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
#h4 = ZJets.drawTH2('h_zjets_uperp_zpt_mu', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "#Delta P_{T}^{#perp}(Z,MET)/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")

h1 = Data.drawTH2('h_data_upara_zpt_mu', 'llnunu_l1_pt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_mu', 'llnunu_l1_pt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_mu', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_mu', 'llnunu_l1_pt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 1000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "P_{T}(Z)", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_zeta_mu', 'abs(llnunu_l1_eta):(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_zeta_mu', 'abs(llnunu_l1_eta):(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_zeta_mu', 'abs(llnunu_l1_eta):(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_zeta_mu', 'abs(llnunu_l1_eta):(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 1000, 0, 10,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "#eta(Z)", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_nvtx_mu', 'nVert:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "nVertex", unitsy = "",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_nvtx_mu', 'nVert:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_nvtx_mu', 'nVert:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_nvtx_mu', 'nVert:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 50, 0, 50,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "N vertex", unitsy = "",drawStyle = "COLZ")
...
h1 = Data.drawTH2('h_data_upara_zpt_set_mu', 'llnunu_l2_sumEt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
h2 = ZJets.drawTH2('h_zjets_upara_zpt_set_mu', 'llnunu_l2_sumEt:(met_pt*cos(llnunu_deltaPhi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#parallel}/P_{T}(Z)",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")


h3 = Data.drawTH2('h_data_uperp_zpt_set_mu', 'llnunu_l2_sumEt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, "(1)", 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
h4 = ZJets.drawTH2('h_zjets_uperp_zpt_set_mu', 'llnunu_l2_sumEt:(met_pt*sin(llnunu_l1_phi-llnunu_l2_phi))/llnunu_l1_pt', cuts+'&&'+muChannel, str(lumi*1000), 1500, -15, 15, 300, 0, 3000,  titlex = "MET^{#perp}/P_{T}",unitsx = "", titley = "sumEt", unitsy = "GeV",drawStyle = "COLZ")
