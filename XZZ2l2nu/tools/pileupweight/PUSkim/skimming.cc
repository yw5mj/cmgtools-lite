...
int main(int argc, char** argv) {
  ...
  TFile* fpileup675 = new TFile("pileup_MC_80x_675.root");
  TFile* fpileup680 = new TFile("pileup_MC_80x_680.root");
  TFile* fpileup685 = new TFile("pileup_MC_80x_685.root");
  TFile* fpileup691 = new TFile("pileup_MC_80x_691.root");
/*
...
*/
  TFile* fpileup698 = new TFile("pileup_MC_80x_698.root");
/*
...
*/
  ...
  TH1D* hpileup675 = (TH1D*)fpileup675->Get("puweight");
  TH1D* hpileup680 = (TH1D*)fpileup680->Get("puweight");
  TH1D* hpileup685 = (TH1D*)fpileup685->Get("puweight");
...
*/
  Double_t puWeight675;
  Double_t puWeight680;
  Double_t puWeight685;
  ...
  TBranch *b_puWeight675 = tree_out->Branch("puWeight675",&puWeight691,"puWeight675/D");
  TBranch *b_puWeight680 = tree_out->Branch("puWeight680",&puWeight691,"puWeight680/D");
  TBranch *b_puWeight685 = tree_out->Branch("puWeight685",&puWeight691,"puWeight685/D");
...
*/
  ...
  for (int i=0; i<(int)tree_out->GetEntries(); i++){
    tree_out->GetEntry(i);
    puWeight675 = hpileup675->GetBinContent(hpileup675->FindBin(nTrueInt)); 
    puWeight680 = hpileup680->GetBinContent(hpileup680->FindBin(nTrueInt)); 
    puWeight685 = hpileup685->GetBinContent(hpileup685->FindBin(nTrueInt)); 
