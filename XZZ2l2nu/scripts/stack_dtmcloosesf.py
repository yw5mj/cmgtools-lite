...
for sample in wwSamples:
    ...
    wwPlotters[-1].addCorrectionFactor('llnunu_l1_l1_lepsf','tree')
    wwPlotters[-1].addCorrectionFactor('llnunu_l1_l2_lepsf','tree')
...
for sample in vvSamples:
    ...
    vvPlotters[-1].addCorrectionFactor('llnunu_l1_l1_lepsf','tree')
    vvPlotters[-1].addCorrectionFactor('llnunu_l1_l2_lepsf','tree')
...
for sample in wjetsSamples:
    ...
    wjetsPlotters[-1].addCorrectionFactor('llnunu_l1_l1_lepsf','tree')
    wjetsPlotters[-1].addCorrectionFactor('llnunu_l1_l2_lepsf','tree')
...
for sample in zjetsSamples:
    ...
    zjetsPlotters[-1].addCorrectionFactor('llnunu_l1_l1_lepsf','tree') 
    zjetsPlotters[-1].addCorrectionFactor('llnunu_l1_l2_lepsf','tree') 
...
for sample in ttSamples:
    ...
    ttPlotters[-1].addCorrectionFactor('llnunu_l1_l1_lepsf','tree') 
    ttPlotters[-1].addCorrectionFactor('llnunu_l1_l2_lepsf','tree') 
...
for sample in sigSamples:
    ...
    sigPlotters[-1].addCorrectionFactor('llnunu_l1_l1_lepsf','tree') 
    sigPlotters[-1].addCorrectionFactor('llnunu_l1_l2_lepsf','tree') 
