...
for sample in samples:
    ...
    for idx in wtIds_pdf:
        ...
        tfrac = float(data[str(lheidx)][1])/float(data['SumLHEOrigWeights'][1])
    ...
    if not ('BulkGrav' in sample):
        ...
        tfrac1 = float(data[str(wtIds_as_bkg[0]+1992)][1])/float(data['SumLHEOrigWeights'][1])
        ...
        tfrac2 = float(data[str(wtIds_as_bkg[1]+1992)][1])/float(data['SumLHEOrigWeights'][1])
