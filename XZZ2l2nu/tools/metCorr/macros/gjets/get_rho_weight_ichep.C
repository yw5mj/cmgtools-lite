{
  ...
  //TFile* file1 = TFile::Open("/home/heli/XZZ/80X_20161006_light_Skim/SingleEMU_Run2016B2H29fbinv_PromptReco.root");
  //TFile* file2 = TFile::Open("/home/heli/XZZ/80X_20161006_light/SinglePhoton_Run2016B2G_PromptReco/vvTreeProducer/tree.root");
  //TFile* file2 = TFile::Open("/home/heli/XZZ/80X_20161006_light_Skim/SinglePhoton_Run2016B2H29fbinv_PromptReco_newFilterLepVetoNoRecoil.root");
  //TFile* fout = TFile::Open("get_rho_weight_b2h29fbinv.root", "recreate");
  TFile* file1 = TFile::Open("/data2/XZZ2/80X_20160825_light_Skim/SingleEMU_Run2016BCD_PromptReco.root");
  TFile* file2 = TFile::Open("/data2/XZZ2/80X_20160927_light_Skim/SinglePhoton_Run2016BCD_PromptReco_newFilterLepVeto.root");
  //TFile* fout = TFile::Open("get_rho_weight.root", "recreate");
  //TFile* fout = TFile::Open("get_rho_weight_ichep_el.root", "recreate");
  TFile* fout = TFile::Open("get_rho_weight_ichep_mu.root", "recreate");
