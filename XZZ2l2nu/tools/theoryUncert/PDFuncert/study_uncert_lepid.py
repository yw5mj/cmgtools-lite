...
for sample in wwSamples:
    ...
    wwPlotters[-1].addCorrectionFactor('(llnunu_l1_l1_lepsf*llnunu_l1_l2_lepsf)','lepeff')
    wwPlotters[-1].addCorrectionFactor('triggersf','trigeff')
...
for sample in vvSamples:
    ...
    vvPlotters[-1].addCorrectionFactor('(llnunu_l1_l1_lepsf*llnunu_l1_l2_lepsf)','lepeff')
    vvPlotters[-1].addCorrectionFactor('triggersf','trigeff')
...
for sample in wjetsSamples:
    ...
    wjetsPlotters[-1].addCorrectionFactor('(llnunu_l1_l1_lepsf*llnunu_l1_l2_lepsf)','lepeff')
    wjetsPlotters[-1].addCorrectionFactor('triggersf','trigeff')
...
for sample in zjetsSamples:
    ...
    zjetsPlotters[-1].addCorrectionFactor('(llnunu_l1_l1_lepsf*llnunu_l1_l2_lepsf)','lepeff')
    zjetsPlotters[-1].addCorrectionFactor('triggersf','trigeff')
...
for sample in ttSamples:
    ...
    ttPlotters[-1].addCorrectionFactor('(llnunu_l1_l1_lepsf*llnunu_l1_l2_lepsf)','lepeff')
    ttPlotters[-1].addCorrectionFactor('triggersf','trigeff')
...
for sample in sigSamples:
    ...
    sigPlotters[-1].addCorrectionFactor('(llnunu_l1_l1_lepsf*llnunu_l1_l2_lepsf)','lepeff')
    sigPlotters[-1].addCorrectionFactor('triggersf','trigeff')
...
## Not finished...
    ...
    hunc_trig[sample].Fill(n1/n0)
    all_var_trig[sample].append(n1/n0)

    allPlotters[sample].changeCorrectionFactor('(triggersfLo)','trigeff')
    h = allPlotters[sample].drawTH1(sample+'_mh_trigDn','llnunu_mta',cuts,str(lumi*1000),50,0,5000,titlex = "M_{T}",units = "GeV",drawStyle = "HIST")
    n2 = h.Integral()
    print '  n2 = '+str(n1)+', n2/n0 = '+str(n2/n0)
    hunc_trig[sample].Fill(n2/n0)
    all_var_trig[sample].append(n2/n0)

    trig_up = n1/n0
    trig_dn = n2/n0
    trig_unc = abs(trig_up-trig_dn)/2.0
    print '  trig_unc = '+str(trig_unc)+', trig_up = '+str(trig_up)+', trig_dn = '+str(trig_dn)
    hunc_trig[sample].Write()

    all_unc_trig[sample] = trig_unc


print '- all_unc_trig: ',all_unc_trig
print '- all_var_trig: ',all_var_trig
