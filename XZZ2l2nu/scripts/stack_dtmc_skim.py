...
tag="80X_L9p17_DataHLT_ZPTwt_AllSF_"
...
lepsf="(trgsf*isosf*idsf*((1.0421*(abs(llnunu_l1_l1_pdgId)==11&&abs(llnunu_l1_l2_pdgId)==11))+(0.9269*(abs(llnunu_l1_l1_pdgId)==13&&abs(llnunu_l1_l2_pdgId)==13))))"
