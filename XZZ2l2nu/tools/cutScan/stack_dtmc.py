...
# electron
h_Data_el = Data.drawTH3('h3d_data_obs_el','llnunu_mta:met_pt:llnunu_l1_pt',cuts+'&&'+elChannel,'(1)',250,0,2500,300,0,3000,500,0,5000,titlex = "P_{T}(Z)",unitsx = "GeV",titley = "MET",unitsy = "GeV",drawStyle = "COLZ")
h_Data_el.Write()

h_VVNonReso_el = WW.drawTH3('h3d_VVNonReso_el','llnunu_mta:met_pt:llnunu_l1_pt',cuts+'&&'+elChannel,str(lumi*1000),250,0,2500,300,0,3000,500,0,5000,titlex = "P_{T}(Z)",unitsx = "GeV",titley = "MET",unitsy = "GeV",drawStyle = "COLZ")
